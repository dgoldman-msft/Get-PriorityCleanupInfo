function Get-PriorityCleanupInfo {
    <#
        ...
        .DESCRIPTION
            ...
            PSCustomObject for each one, making the results easy to pipe, export, or format.
        ...
        .PARAMETER LogDirectory
            Directory for the timestamped log file (Logging_<stamp>.txt).
        ...
        .EXAMPLE
            Get-PriorityCleanupInfo | Format-List

            Uses an existing session (no auto-connect) and displays all results as a list.
        ...
        .OUTPUTS
            PSCustomObject — one object per Priority Cleanup policy with properties:
    ...
    begin {
        ...
        #region --- Connect to Security & Compliance Center (always runs when UPN available) ---
        try {
